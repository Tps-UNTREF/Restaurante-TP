...
public class ModuloPreciosTest {
	...
	@Test
	public void productoUnico_getCategoria()
			throws PrecioDeVentaInvalidoException,
			PrecioDeCostoInvalidoException {

		ProductoUnico cocacola = new ProductoUnico("Coca Cola", 5, 25,
				Categorias.BebidaSinAlcohol);
	...
	@Test
	public void productoUnico_getDescripcion()
			throws PrecioDeVentaInvalidoException,
			PrecioDeCostoInvalidoException {

		ProductoUnico milanesaNapolitana = new ProductoUnico(
				"Milanesa Napolitana", 10, 50, Categorias.Minutas);

		assertEquals("Milanesa Napolitana", milanesaNapolitana.getDescripcion());
	}

	@Test
	public void productoUnico_getPrecioDeCosto()
			throws PrecioDeVentaInvalidoException,
			PrecioDeCostoInvalidoException {
	...
	@Test
	public void productoUnico_getPrecioDeVenta()
			throws PrecioDeVentaInvalidoException,
			PrecioDeCostoInvalidoException {

		ProductoUnico hamburguesa = new ProductoUnico("Hamburguesa", 20, 55,
	...
	@Test
	public void combo_getDescuento() throws PrecioDeVentaInvalidoException,
			DescuentoInvalidoException, PrecioDeCostoInvalidoException {
	...
	@Test
	public void combo_agregaUnProductoAlComboYVerificaQueSeAgrego()
			throws PrecioDeVentaInvalidoException,
			PrecioDeCostoInvalidoException, DescuentoInvalidoException,
			CantidadDeProductosInvalidoException {

		Combo combo = new Combo("Combo dos pizzas", 20);

		ProductoUnico pizza = new ProductoUnico("Pizza", 15, 60,
				Categorias.Pizzas);
	...
	@Test
	public void combo_borrarProductoDelComboYVerificarQueSeBorro()
	...
	@Test
	public void combo_agregarVariosProductosYVerificarElPrecioDeCostoTotal()
			throws PrecioDeVentaInvalidoException, DescuentoInvalidoException,
			PrecioDeCostoInvalidoException,
			CantidadDeProductosInvalidoException {
		...
		ProductoUnico pizzaChica = new ProductoUnico("Pizza chica", 10, 40,
				Categorias.Pizzas);
		ProductoUnico hamburguesa = new ProductoUnico("Hamburguesa", 15, 55,
				Categorias.Hamburguesas);
		ProductoUnico cocacola = new ProductoUnico("Coca Cola", 7, 30,
				Categorias.BebidaSinAlcohol);
	...
	public void combo_agregarVariosProductosYVerificarElPrecioDeVentaTotalAplicadoElDescuento()
		...
		ProductoUnico pizzaChica = new ProductoUnico("Pizza chica", 10, 30,
				Categorias.Pizzas);
		ProductoUnico hamburguesaConQueso = new ProductoUnico(
				"Hamburguesa con queso", 15, 45, Categorias.Hamburguesas);
		ProductoUnico cocacola = new ProductoUnico("Coca Cola", 7, 25,
				Categorias.BebidaSinAlcohol);
	...
	public void moduloPrecios_agregarProductoAlMenuYVerificarQueSeAgrego()
		...
		ProductoUnico agua = new ProductoUnico("Agua", 5, 25,
				Categorias.BebidaSinAlcohol);
	...
	@Test
	public void moduloPrecios_getProductoConSuCodigo()
			throws PrecioDeVentaInvalidoException,
			PrecioDeCostoInvalidoException {

		ProductoUnico cerveza = new ProductoUnico("Cerveza", 15, 40,
	...
	@Test
	public void moduloPrecios_getProductoConSuDescripcion()
			throws PrecioDeVentaInvalidoException,
			PrecioDeCostoInvalidoException {

		ProductoUnico hamburguesa = new ProductoUnico("Hamburguesa", 20, 50,
				Categorias.Hamburguesas);
	...
	public void moduloPrecios_actualizarProductoYVerificarQueSeReemplazaron()
			throws PrecioDeVentaInvalidoException,
			PrecioDeCostoInvalidoException,
			ProductoActualizadoYaExistenteException,
			ProductoAActualizarNoExistenteException,
			ProductoADarDeBajaNoExistenteException {

		ProductoUnico cocacola = new ProductoUnico("Coca Cola", 10, 30,
				Categorias.BebidaSinAlcohol);

		moduloPrecios.altaProducto(cocacola);

		ProductoUnico pepsi = new ProductoUnico("Pepsi", 7, 28,
				Categorias.BebidaSinAlcohol);

		moduloPrecios.actualizarProducto(cocacola, pepsi);

		assertTrue(moduloPrecios.existeProducto(pepsi));
		assertFalse(moduloPrecios.existeProducto(cocacola));

	}

	@Test
	public void moduloPrecios_imprimirMenu()
			throws PrecioDeVentaInvalidoException,
			PrecioDeCostoInvalidoException, DescuentoInvalidoException,
			CantidadDeProductosInvalidoException {

		ProductoUnico gaseosa = new ProductoUnico("Gaseosa", 10, 30,
				Categorias.BebidaSinAlcohol);
		ProductoUnico aguaMineral = new ProductoUnico("Agua mineral", 5, 25,
				Categorias.BebidaSinAlcohol);
		ProductoUnico aguaSaborizada = new ProductoUnico("Agua saborizada", 7,
				25, Categorias.BebidaSinAlcohol);
		ProductoUnico cerveza = new ProductoUnico("Cerveza", 20, 55,
				Categorias.BebidaConAlcohol);
		ProductoUnico whisky = new ProductoUnico("Whisky", 40, 90,
				Categorias.BebidaConAlcohol);
		ProductoUnico hamburguesaSola = new ProductoUnico("Hamburguesa sola",
				15, 50, Categorias.Hamburguesas);
		ProductoUnico hamburguesaJamonYQueso = new ProductoUnico(
				"Hamburguesa con jamon y queso", 20, 60,
				Categorias.Hamburguesas);
		ProductoUnico hamburguesaTomateYLechuga = new ProductoUnico(
				"Hamburguesa con tomate y lechuga", 20, 60,
				Categorias.Hamburguesas);
		ProductoUnico hamburguesaCompleta = new ProductoUnico(
				"Hamburguesa completa", 30, 65, Categorias.Hamburguesas);
		ProductoUnico milanesa = new ProductoUnico("Milanesa", 20, 60,
				Categorias.Minutas);
		ProductoUnico milanesaNapolitana = new ProductoUnico(
				"Milanesa napolitana", 25, 70, Categorias.Minutas);
		ProductoUnico pizzaMuzzarella = new ProductoUnico(
				"Pizza de muzzarella", 25, 75, Categorias.Pizzas);
		ProductoUnico pizzaNapolitana = new ProductoUnico("Pizza napolitana",
	...
	public void agregarProductoAlComboConCantidadIncorrecta()
			throws PrecioDeVentaInvalidoException,
			PrecioDeCostoInvalidoException, DescuentoInvalidoException,
			CantidadDeProductosInvalidoException {

		ProductoUnico producto = new ProductoUnico("Producto", 10, 30,
				Categorias.BebidaConAlcohol);
	...
	public void crearProductoConPrecioDeCostoInvalido()
		...
		@SuppressWarnings("unused")
		ProductoUnico producto = new ProductoUnico("Producto", -5, 10,
				Categorias.BebidaSinAlcohol);
	...
	public void crearProductoConPrecioDeVentaMenorAlPrecioDeCosto()
		...
		@SuppressWarnings("unused")
		ProductoUnico producto = new ProductoUnico("Producto", 20, 10,
				Categorias.BebidaSinAlcohol);

	}

	@Test(expected = ProductoAActualizarNoExistenteException.class)
	public void reemplazarUnProductoNoExistentePorOtro()
			throws PrecioDeVentaInvalidoException,
			PrecioDeCostoInvalidoException,
			ProductoActualizadoYaExistenteException,
			ProductoAActualizarNoExistenteException,
		...
		ProductoUnico producto1 = new ProductoUnico("Producto 1", 5, 10,
				Categorias.BebidaSinAlcohol);
		ProductoUnico producto2 = new ProductoUnico("Producto 2", 5, 10,
				Categorias.BebidaSinAlcohol);

		moduloPrecios.actualizarProducto(producto1, producto2);

	}

	@Test(expected = ProductoADarDeBajaNoExistenteException.class)
	public void darDeBajaAUnProductoNoExistente()
