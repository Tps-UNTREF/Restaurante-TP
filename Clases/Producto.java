...
public abstract class Producto implements Comparable<Producto> {
	...
	/**
	 * pre: El precio de venta debe ser mayor a cero y el precio de costo debe ser mayor a cero y menor que el precio de venta.
	 * post: Se crea el producto.
	 */
	public Producto(String descripcion, double precioDeCosto, double precioDeVenta, Categorias categoria) throws PrecioDeVentaInvalidoException, PrecioDeCostoInvalidoException {
		contadorId++;
	...
	/**
	 * pre: El precio de costo debe ser mayor a cero.
	 * post: Cambia el precio de costo.
	 */
	public void setPrecioDeCosto(double precioDeCosto) throws PrecioDeCostoInvalidoException {
		if(precioDeCosto > 0) {
	...
	/**
	 * pre: El precio de venta debe ser mayor al precio de costo.
	 * post: Cambia el precio de venta.
	 */
