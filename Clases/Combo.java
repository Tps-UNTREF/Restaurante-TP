...
public class Combo extends Producto {
	...
	/**
	 * pre: Debe ingresarse una descripción valida y un descuento comprendido entre 0 y 100.
	 * post: Crea el combo.
	 */
	public Combo(String descripcion, int descuento) throws PrecioDeVentaInvalidoException, DescuentoInvalidoException, PrecioDeCostoInvalidoException {
	...
	/**
	 * pre: El valor del descuento debe estar comprendido entre 0 y 100.
	 * post: Cambia el porcentaje del descuento.
	 */
	 ...
	 */
	public void agregarProducto(Producto producto, int cantidad) throws CantidadDeProductosInvalidoException, PrecioDeVentaInvalidoException, PrecioDeCostoInvalidoException {
	 ...
	 */
	public void borrarProducto(Producto producto) throws PrecioDeVentaInvalidoException, PrecioDeCostoInvalidoException {
	 ...
	 */
	public void aplicarPrecios() throws PrecioDeVentaInvalidoException, PrecioDeCostoInvalidoException {
		...
		super.setPrecioDeVenta(precioDeVentaTotal - (descuento * precioDeVentaTotal / 100));
		super.setPrecioDeCosto(precioDeCostoTotal);
	}
	
	public void imprimir() {
		System.out.println(getCodigoDeProducto() + "..." + getDescripcion() + leftPad(getPrecioDeVenta(), 50, '.', getDescripcion()));
		for(Entry<Producto, Integer> p : productos.entrySet()) {
			System.out.println("- " + p.getValue() + " " + p.getKey().getDescripcion());
		}
	}

	private String leftPad(Object original, int length, char padCharacter, Object descripcion) {
		String paddedString = original.toString();
		String descripcionDelProducto = descripcion.toString();
      	while (paddedString.length() < length-descripcionDelProducto.length()-1) {
