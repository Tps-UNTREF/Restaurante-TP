...
public class ModuloPrecios {
	...
	public void getProducto(int codigoDeProducto) {
		for (Producto p : productos) {
			if (p.getCodigoDeProducto() == codigoDeProducto) {
				System.out
						.println("El producto " + p.getCategoria() + " " + p.getDescripcion() + " con precio de costo $"
	...
	/**
	 * pre: El producto debe estar en la lista. post: Borra el producto de la
	 * lista.
	 */
	...
	/**
	 * pre: El producto a actualizar debe existir en la lista. post: Se da de
	 * baja al producto desactualizado y se ingresa el actualizado.
	 */
