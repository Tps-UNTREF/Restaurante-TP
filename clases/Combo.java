...
public class Combo extends Producto {
	 ...
	 */
	public void setDescuento(int descuento) throws DescuentoInvalidoExcepcion {
		if (descuento > 0 && descuento < 100) {
			this.descuento = descuento;
		} else {
			throw new DescuentoInvalidoExcepcion();
		}
	}
	...
	public void agregarProducto(Producto producto, int cantidad)
			throws CantidadDeProductosInvalidoExcepcion,
		...
		if (!productos.containsKey(producto) && cantidad > 0) {
			...
			throw new CantidadDeProductosInvalidoExcepcion();
		}
	}
	 ...
	 */
	private void aplicarPrecios() throws PrecioDeVentaInvalidoExcepcion,
			PrecioDeCostoInvalidoExcepcion {
